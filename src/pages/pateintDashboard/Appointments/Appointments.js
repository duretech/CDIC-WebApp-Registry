...
const Appointments = () => {
            ...
            if(response.status == 200) {
                ...
                if(response.data.data && response.data.data.length > 0) {
                    ...
                    allData.forEach(element => {
                        ...
                        let getFromTime = element.fromtime && element.fromtime.length > 0 ? element.fromtime + ':00' : '00:00:00';
                        let getToTime = element.totime && element.totime.length > 0 ? element.totime + ':00' : '01:00:00';
    ...
    return (
        <main spacing={""} className="pl-30px appointmentpage">
            ...
            <Grid container spacing={2} className='mt-30px w-100'>
                <Grid item xs={12} className="pl-0">
                    ...
                    <Dialog maxWidth={maxWidth} onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
