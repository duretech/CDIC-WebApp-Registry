            ...
            <section className={classes.homepagemainsection}
                ...
                <div className={classes.toptutorialmenu}>
                    <div>
                        ...
                        <p className={classes.icondescription}>CHATBOT HELPDESK</p>
                    </div>
                    <div>
                        <p className={classes.icon}>
                            <FontAwesomeIcon icon={faVideo} />
                        </p>
                        <p className={classes.icondescription}>VIDEO TUTORIAL</p>
                    </div>
                    <div>
                        <p className={classes.icon}>
                            <FontAwesomeIcon icon={faEye} />
                        </p>
                        <p className={classes.icondescription}>GUIDED TUTORIAL</p>
                    </div>
                    <div>
                        <p className={classes.icon}>
                            <FontAwesomeIcon icon={faFilePdf} />
                        </p>
                        <p className={classes.icondescription}>PDF TUTORIAL</p>
                    </div>
                </div>
                <div className={classes.bottomstatsmain}>
                    ...
                    <div className={classes.bottomdivfull}></div>
                </div>
            </section>
