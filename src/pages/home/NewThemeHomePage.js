...
function NewThemeHomePage(props) {
  ...
  const [lineChartType, setLineChartType] = useState(
    APP_LOCALE === 'GANDHIO' ? 'Basal Insulin' : 'Insulin'
  );
                            ...
                            dataElementGroup.data.dataElementGroups.map(
                              (dataElementGroups) => {
                                ...
                                if (findFlag) {
                                  ...
                                  deGroupArray.push(dataElementGroups);
                                }
                              }
                            );
                            OfflineDb.setDataIntoPouchDB(
                              "dataElementGroup",
                              { "dataElementGroups": deGroupArray }
                            );
                            setProgress(40);
      ...
      <div className={classes.container}>
        <main style={{ display: "flex", height: "100%", width: "100%" }}>
          ...
          >
            ...
            { APP_LOCALE === "CC004" || APP_LOCALE === "ETHIOPIA" ?
              <Grid container spacing={0} className="">
              {reloadData && progress != 100 ? (
                <Box
                  display="flex"
                ...
                >
                  <Typography variant="h6" className="homepageappdesc">
                    {t("Loading...")}
                  </Typography>
                   ...
                   <div className="transferBox">
                    ...
                    <div className="pt-30 mainLandingHome" style={{ marginTop: "72px" }}>
                      <div className="main-cdic-dashboard">
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={APP_LOCALE === "CC012" ? 6 : 12} sm={APP_LOCALE === "CC012" ? 6 : 4} md={APP_LOCALE === "CC012" ? 6 : 4}
                            lg={APP_LOCALE === "CC012" ? 6 : 4}>
                                  ...
                                  <div className="main-first-section">
                                    <p>
                                      {(APP_LOCALE != "CC007" ?
                                        ...
                                        :
                                        <>
                                          {t("TOTAL PATIENTS FOLLOWED UP TILL NOW")}
                                        </>)}
                        ...
                        <div className="main-second-mainchartSection">
                          ...
                          >
                            <Grid item xs={12} sm={6} md={6} lg={6} className="blur-container">
                              <Card variant="outlined" className="bg-lightgrey">
                          ...
                          >
                            ...
                            <Grid item xs={12} sm={6} md={6} lg={6}>
                              <Card variant="outlined" className="bg-lightgrey">
                                <CardContent className="pb-0">
                                  {/* <div className="main-second-section">
                              <h4 className="mt-0 mb-0">INCIDENCE OF DEATH</h4>
                            </div> */}
                                  <div className="main-second-section mb-2">
                                    <div className="heading">
                                      <h4 className="mt-0 mb-0">
