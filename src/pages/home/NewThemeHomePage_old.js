...
function NewThemeHomePage({setLoginUser}) {
      ...
      <main style={{ display: "flex", height: "100%", width: "100%" }}>
        ...
        >
          ...
          {reloadData && progress != 100 ? (
            ...
            <Grid item xs={9} sm={9} md={9} className="rightsection">
                <div className="rightsectiontoppart">
                  ...
                  <div className="statboxesholdermain">
                    ...
                    <div className="statbox one">
                      <p className="statnumber">{registerdClient ? registerdClient : 0}</p>
                    ...
                    <div className="statbox four">
                      <p className="statnumber">{alertCount ? alertCount : 0}</p>
...
export default connect(null, {setLoginUser })(NewThemeHomePage);
