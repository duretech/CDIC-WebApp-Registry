            ...
            <Grid container className='termsgrid'>
                <Grid item xs={12} className='termstitlegrid'>
                    <div className='termstitle'>
                        <Typography variant='h5' className='oneuhcfont'>Terms and Conditions - Health Provider</Typography>
                    </div>
                </Grid>
                ...
                <Grid item xs={12} className='termsbtnsgrid'>
                    <div className='termsbtns'>
                        <Button className='termbtn agree oneuhcfont'>I AGREE</Button>
                        <Button className='termbtn disagree oneuhcfont'>I DON'T AGREE</Button>
                    </div>
                </Grid>
            </Grid>
        </div>
