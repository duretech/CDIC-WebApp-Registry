    ...
    <div className={classes.root}>
      <Accordion defaultExpanded>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography className={classes.heading}>E.ECONOMIC STRENGTHENING</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            <div>
              <p className="sectionquestiontitle">1.Financial Management</p>
            </div>
            <div>
           ...
           <Typography className="mt-30px">
            <div>
              <p className="sectionquestiontitle">2.Financial Autonomy</p>
            </div>
            <div>
              <Grid container spacing={3} className="">
              <Grid item xs={12} sm={6} md={6} lg={3}>
