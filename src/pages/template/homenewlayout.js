    ...
    >
        ...
        >
            ...
            <Grid container spacing={3} className="mt-30px">
              <Grid item xs={12}>
                <p className={classes.homepageappname}>Save The Children</p>
                <p className={classes.homepageappdesc}>A Community Engagement Platform Designed Monitor Barriers To Access Facilities,Communities And Civil Organisations.</p>
              </Grid>
            </Grid>
            ...
            <Grid container spacing={3}>
              <Grid item xs={12}>
                <p className={classes.homepageachtitle}>Our Achievment</p>
                <Grid container spacing={3} className="progresscontainer">
              <Grid item xs={12} sm={4}>
               <p><Customcircularprogress></Customcircularprogress></p>
               <p className={classes.homepageappdesc}>Auto Alerts</p>
              </Grid>
              <Grid item xs={12} sm={4}>
               <p><Customcircularprogress1></Customcircularprogress1></p>
               <p className={classes.homepageappdesc}>Assigned Tasks</p>
              </Grid>
              <Grid item xs={12} sm={4}>
               <p><Customcircularprogress2></Customcircularprogress2></p>
               <p className={classes.homepageappdesc}>Pending Services</p>
              </Grid>
            </Grid>
              </Grid>
            </Grid>
