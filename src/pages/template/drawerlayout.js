...
import CustomSnackbarInfo from './CustomSnackbarInfo.js'
...
const SearchCasesPage = () => {
    ...
    <div>
<Header  toggleDrawer={(isClicked, isOpen) => toggleDrawer(isClicked, isOpen)}></Header>
    ...
    >
        ...
        >
            ...
            <p className={classes.searchformheading}>Drawer</p>
             <CustomDrawer 
            ...
            <br/>
            <CustomSnackbarInfo></CustomSnackbarInfo> 
            </div>
        </section>
    </main>
    </div>
