...
import Customservicescard from './Customservicescard.js';



const Servicecardnewlayout = () => (
          ...
          <Typography variant="h6" noWrap className="pt-0px">
            ...
            <Grid container spacing={3} className="mt-90px mb-30px">
              <Grid item xs={12} sm={6} md={3}>
                <Customservicescard></Customservicescard>
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
                <Customservicescard></Customservicescard>
              </Grid>
...
export default Servicecardnewlayout
